...
Before implementing, **create a new feature branch** from the repo base branch; open a **Pull Request** for all work and **do not merge** until the **maintainer approves** (`ai-specs/specs/git-workflow.mdc`). Use `gh` for PR creation when applicable.
